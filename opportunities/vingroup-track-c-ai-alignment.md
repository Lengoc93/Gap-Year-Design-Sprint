# Vingroup — Track C: Giáp Lê's Team (AI Alignment / BKTT)

**Type:** Full-time senior role — PM for AI Alignment product (T4 level)
**Source:** Opened after Track B closed (May 13); interview with Giáp Lê May 14
**Status:** `Offer Letter Received — Accepted (June 11, 2026)`
**File opened:** Mar 13, 2026

> **Group-level note:** This is one of three parallel tracks pursued at Vingroup / VinSmartFuture, all reporting to the same VP (Phạm Nhật Hoàng, heir). The conglomerate's group nature dominates the culture of every track, so **Part 1 (Group / Conglomerate Context)** below applies in full to this track. **Part 2** holds the Track C–specific detail, including the accepted offer.

---

# PART 1 — GROUP / CONGLOMERATE CONTEXT (shared across all tracks)

## Approach: Multi-Team Track

> Multiple data-science-driven teams under the same VP (Phạm Nhật Hoàng, heir). Running touchpoints for several simultaneously to maximize efficiency. Shared org/culture/compensation analysis applies to all; team-specific assessment tracked separately.
...
## Opening Questions — Shared (all teams)
...
| 5   | Approval chains and documentation overhead for a typical product/data decision?                                                                                                                                                                                                                | `Important`    | `Open` | June 15 - Align with T3 on high level/principle level so for rough delivery timeline. So that T3 can align upper level expectation of scope and timeline. Then, during the exe stage, phase out and sync by deliverable timelines and critical updates         |
...
## Research Notes — Conglomerate level
...
## Shared Touchpoints (group-level)
...
## Running Verdict (full journey across all tracks)
...
## Opening Questions — Track C (AI Alignment)
